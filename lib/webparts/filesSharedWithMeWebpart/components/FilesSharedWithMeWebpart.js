                ...
                success: function (data) {
                    ...
                    if (files !== "") {
                        files.forEach(function (element) {
                            ...
                            var result = {
                                "Author": table.find(function (d) { return d.Key === "Author"; }).Value.replace(';', ', '),
                                "Path": table.find(function (d) { return d.Key === "ServerRedirectedURL"; }).Value,
                                "LastModifiedTimeMoment": moment(table.find(function (d) { return d.Key === "LastModifiedTime"; }).Value).format("DD.MM.YYYY"),
                                "LastModifiedTime": table.find(function (d) { return d.Key === "LastModifiedTime"; }).Value,
                                "Title": table.find(function (d) { return d.Key === "Title"; }).Value
                            };
