...
export interface IClientSideComponentManifest {
    ...
    version: string;
    /**
     * Definition: If true, the component is allowed on sites where the Custom Script (https://support.office.com/en-us/article/Turn-scripting-capabilities-on-or-off-1f2c515f-5d7e-448a-9fd7-835da935584f)
     *  toggle is disabled. This means that the component will not allow arbitrary scripts to be executed. This property
     *  defaults to false. This property does not apply to library components.
     * Usage: Allows this component to be used on a site with the Custom Script toggle turned off.
     * Required: no
     * Localized: no
